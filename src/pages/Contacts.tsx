...
const Contacts = () => {
    ...
    return (
        <section className="bg-[url('/bg-home.jpg')] py-10">
            ...
            >
                <div className="p-10 lfex flex-col gap-10">
                    ...
                    <button
                        type="submit"
                        className="py-3 px-10 rounded-md mt-4 bg-green-600 font-bold duration-300 text-white hover:text-green-500 hover:bg-slate-50 border border-green-500"
                    >
                        Submit
                    </button>
                </div>
